...
public class Teacherdetail extends JFrame implements ActionListener
{
    ...
    JTable t1;
    JTextField t2;
    String x[]={"Name","FatherName","Age","DOB","Address","phone","Email","ClassX","ClassXII","Aadhar","Course","Emp_id","Dept"};
    String y[][]=new String[20][13];
    int i=0,j=0;
    Teacherdetail()
    {
        
          JLabel l1=new JLabel("Add new Teacher");
        l1.setFont(new Font("System",Font.CENTER_BASELINE,25));
        l1.setBounds(30,500,400,25);
        add(l1);
        
          JLabel l2=new JLabel("Update Teacher Detail");
        l2.setFont(new Font("System",Font.CENTER_BASELINE,25));
        l2.setBounds(30,565,400,25);
        add(l2);
        
        JLabel l3=new JLabel("Enter Emp-id To Delete Teacher");
   ...
   public void actionPerformed(ActionEvent ae)
    {
        ...
        else if(ae.getSource()==b3)
        {
            ...
            conn c1=new conn();
            String q1="delete from teacher where emp_id='"+id+"'";
