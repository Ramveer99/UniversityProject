...
public class Student extends JFrame implements ActionListener
{
    ...
    Student()
    {
        ...
        ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("universitysystem/icon/fourth.jpg"));
        Image i2=i1.getImage().getScaledInstance(750, 440,Image.SCALE_DEFAULT);
        ImageIcon i3=new ImageIcon(i2);
        JLabel l2=new JLabel(i3);
        l2.setBounds(0,0,750,465);
        add(l2);
        
         JLabel l1=new JLabel("New Student Detail");
        l1.setFont(new Font("System",Font.CENTER_BASELINE,25));
        l1.setBounds(240,0,400,25);
        l2.add(l1);
       ...
       l2.add(t5);
        ...
        l16.setFont(new Font("System",Font.BOLD,22));
        l16.setBounds(25,298,160,50);
        l2.add(l16);
        
        t12=new JTextField();
       // t1.setFont(new Font("System",Font.BOLD,15));
       t12.setText("18023"+first);
       t12.setBounds(170,312,130,20);
       l2.add(t12);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if(ae.getSource()==b1)
        {
            ...
            conn c1=new conn();
            String q1="insert into student values('"+name+"','"+fname+"','"+age+"','"+dob+"','"+address+"','"+phone+"','"+email+"','"+classx+"','"+classxii+"','"+Aadhar+"','"+roll+"','"+Education+"','"+dept+"')";
           try
           {
